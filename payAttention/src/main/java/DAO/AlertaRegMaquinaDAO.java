    ...
    public boolean registrarAlertaMaquina() throws SQLException {
        ...
        try{
            ...
            if (rsMaquina.next()) {
                ...
                // System.out.println("ENTREI NA DESGRAÇA DO IF");

                while (rsRegistro.next()) {
                    // System.out.println("ENTREI NA PORRA DO WHILE");
                ...
                if (ramAtual.get(0) >= (ramLimite - (ramLimite*0.1))) {
                    if (ramAtual.get(0) >= (ramLimite - (ramLimite*0.1)) && ramAtual.get(0) < ramLimite) {
                        ...
                        try{
                            ...
                            ps.execute();
                            // System.out.println("entrei aqui ATENCAOOOO");
                        ...
                        try {
                            ...
                            ps.setInt(3,idReg.get(0));
                            ps.execute();
                            // System.out.println("entrei aqui CRITICOOOOOOOOOO");
                        } catch (SQLException ex) {
                            System.out.println(ex);
                        }
                    }
            ...
            System.out.println(cpuAtual.toString());
